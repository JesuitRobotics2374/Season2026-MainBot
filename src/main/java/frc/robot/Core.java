...
public class Core {
    ...
    public Core() {
        ...
        boolean isCompetition = false; //CHANGE THIS TO TRUE FOOR ONLY COMPETITION AUTOS

        configureAutoCommands();
        autoChooser = AutoBuilder.buildAutoChooserWithOptionsModifier(
        (stream) -> isCompetition //also can change "isCompetition" to "true" if we always want it
